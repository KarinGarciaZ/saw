          ...
          ?>
            ...
            <div class="size13 bo4 m-b-12">
				...
				<div class="size15 trans-0-4">
					<!-- Button -->
					<button type="submit" onclick="callOtherFunction()" class="block2-name flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4">Generar pedido</button>
				</div>
      </div>
      <?php } 
      }
